...
<?php 
    ...
    ?>
        ...
        <div id="isikotak">
        <font style="margin-left: 560px;">Danau Toba</font>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets/Gallery/Danau Toba2.jpg" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/Gallery/Danau Toba3.jpg" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/Gallery/Danau Toba4.jpg" alt="...">
          </div>
