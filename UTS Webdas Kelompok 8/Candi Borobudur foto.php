...
<div id="isikotak">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets/Gallery/Candi Borobudur2.jpg" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/Gallery/Candi Borobudur3.jpg" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/Gallery/Candi Borobudur4.jpg" alt="...">
          </div>
        </div>
