...
<div id="isikotak">
        <font style="margin-left: 570px;">Raja Ampat</font>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets/Gallery/Raja Ampat2.jpg" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/Gallery/Raja Ampat3.jpg" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/Gallery/Raja Ampat4.jpg" alt="...">
          </div>
        </div>
