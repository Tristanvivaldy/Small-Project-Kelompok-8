...
<div id="isikotak">
        <font style="margin-left: 540px;">Pulau Komodo</font>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets/Gallery/Pulau Komodo2.jpg" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/Gallery/Pulau Komodo3.jpg" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/Gallery/Pulau Komodo4.jpg" alt="...">
          </div>
        </div>
